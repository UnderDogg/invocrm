...
<html>
    <head>
        ...
        <!-- Ionicons -->
        <?php echo $this->tag->stylesheetLink('plugins/admin-lte/css/ionicons.min.css'); ?>
        <!-- Theme style -->
    ...
    <body class="skin-blue">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <?php echo $this->tag->image(array('img/avatar3.png', 'class' => 'img-circle', 'alt' => 'User Image')); ?>
                                                </div>
                                                <h4>
                                                    Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <?php echo $this->tag->image(array('img/avatar2.png', 'class' => 'img-circle', 'alt' => 'User Image')); ?>
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <?php echo $this->tag->image(array('img/avatar.png', 'class' => 'img-circle', 'alt' => 'User Image')); ?>
                                                </div>
                                                <h4>
                                                    Developers
        ...
        <!-- jQuery UI 1.10.3 -->
        <?php echo $this->tag->javascriptInclude('plugins/admin-lte/js/jquery-ui-1.10.3.min.js'); ?>
        <!-- Bootstrap -->
        <?php echo $this->tag->javascriptInclude('plugins/admin-lte/js/bootstrap.min.js'); ?>
        <!-- AdminLTE App -->
        <?php echo $this->tag->javascriptInclude('plugins/admin-lte/js/AdminLTE/app.js'); ?>
    </body>
</html>