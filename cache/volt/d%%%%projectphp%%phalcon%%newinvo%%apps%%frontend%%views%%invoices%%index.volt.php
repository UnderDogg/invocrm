...
<!-- DATA TABLES -->
<?php echo $this->tag->stylesheetLink('plugins/admin-lte/css/datatables/dataTables.bootstrap.css'); ?>
<!-- DATA TABES SCRIPT -->
<?php echo $this->tag->javascriptInclude('plugins/admin-lte/js/plugins/datatables/jquery.dataTables.js'); ?>
<?php echo $this->tag->javascriptInclude('plugins/admin-lte/js/plugins/datatables/dataTables.bootstrap.js'); ?>
